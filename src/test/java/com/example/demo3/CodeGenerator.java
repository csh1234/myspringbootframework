...
import com.example.demo3.common.ProjectConstant;
...
/**
 * @author: CSH
 * @description: 逆向工程测式类  代码生成器，根据数据表名称生成对应的Model、Mapper简化开发。
 * @create: 2020-04-24 16:03
 **/
public class CodeGenerator {
    // JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/test1?useUnicode=true&characterEncoding=utf-8";
    private static final String JDBC_USERNAME = "root";
    private static final String JDBC_PASSWORD = "admine";
